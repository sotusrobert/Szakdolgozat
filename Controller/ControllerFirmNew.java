...
public final class ControllerFirmNew {

    private final FirmEdit view;
    private final ServiceFirm service;

    public ControllerFirmNew() {
        view = new FirmEdit();
    ...
    public final void initView() {
        ...
        view.getjBut_Exit().setEnabled(false);
        view.getjBut_Exit().setToolTipText("Adja meg a Saját cég adatit!");
    }
        ...
        view.getjBut_Save().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int n = JOptionPane.showOptionDialog(view,
                        "Valóban menteni akarj az adatokat?",
                        "Figyelem",
